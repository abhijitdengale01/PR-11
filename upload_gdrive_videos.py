...
def get_google_drive_credentials():
    ...
    CREDENTIALS_DRIVE_LINK = "https://drive.google.com/file/d/1K_6ZNCl6vvTN5Cun8kFyI-IQdD_-GzYB/view?usp=sharing"
...
def get_youtube_credentials(channel_id=None, channel_name=None):
    ...
    CHANNEL_DRIVE_LINKS = {
        "Kblitz": "https://drive.google.com/file/d/11rpqmypdv2rY7gDNXDw5bIYuQgO7MWVU/view?usp=sharing",
        "MovieBiteExplained": "https://drive.google.com/file/d/1KfK6loR3eh4E41gjXK66vnSADXgnAtZW/view?usp=sharing",
        "NayiDuniyaDramas": "https://drive.google.com/file/d/1e2yNnAXfa5Xa0uJW7f3JE5LzUbNQgU9u/view?usp=sharing",
        "SwarLayDramasHindi": "https://drive.google.com/file/d/1qoHQP6PPQRLWg0Ljch4odiYXVPkmFf-h/view?usp=sharing"
    }
...
def clean_video_title(title):
    """Clean video title to make it YouTube-compatible."""
    import re
...
def process_direct_folder_videos(folder_id, channel_id=None, channel_name=None, limit=None, random_selection=True):
    ...
    try:
        ...
        for idx, video_file in enumerate(selected_videos):
            ...
            # Use filename as title (without extension) and clean it
            raw_title = os.path.splitext(file_name)[0]
            # Clean title: remove emojis, special chars, and limit length
